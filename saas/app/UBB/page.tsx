...
import { SuperAIHeader } from '@/components/ui/superai-header';
...
export default function NewHackPage() {
  ...
  return (
    <main className="min-h-screen pt-0 mt-0" style={{ background: 'linear-gradient(to bottom right, #f8f5fc, #f0ebf8, #e8e0f5)' }}>
      <SuperAIHeader />
      {/* Plan cards */}
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="w-full bg-white rounded-2xl shadow-xl p-6">
            <div className="text-center">
              ...
              <div className="text-xl font-extrabold tracking-tight text-gray-900 mb-1">
                <span className="align-top text-2xl mr-1">$</span>200.00
